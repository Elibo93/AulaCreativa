...
public record ProfesorRequest(
	...
	String nombre,
	@NotBlank(message = "{profesor.valid.apellido.no_vacio}")
	String apellido,
	@NotBlank(message = "{profesor.valid.especialidad.no_vacio}")
    String especialidad,
	@NotBlank(message = "{profesor.valid.email.no_vacio}")
	@Email(message = "{common.error.email_no_valido}")
	String email,
	@NotBlank(message = "{profesor.valid.telefono.no_vacio}")
	String telefono) {
