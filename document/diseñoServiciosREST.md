...
- **Profesores**
    ...
    | Operación               | Verbo  | Endpoint                            | Ejemplo Body                                                                                                                   | Response Code        | Ejemplo Response                                        | Errores posibles                                                                               |
    |-------------------------|--------|---------------------------------------|----------------------------------------------------------------------------------------------------------------------------------|----------------------|----------------------------------------------------------|------------------------------------------------------------------------------------------------|
    | **Crear profesor**      | POST   | `/api/v1/profesores`                 | `{ "nombre": "Laura", "apellidos": "García", "especialidad": "Dibujo", "email": "laura@example.com", "telefono": "600999888", "activo": true }` | **201 (Created)**    | `{ "id_profesor": 2, "nombre": "Laura", "apellidos": "García", "especialidad": "Dibujo, "fecha_alta": "2025-09-15"  }`               | **400 (Solicitud duplicada)**, **401 (No autorizado)**, **409 (email duplicado)**                                                   |
    | **Listar profesores**   | GET    | `/api/v1/profesores` | —                                                                                                                              | **200 (OK)**         | `{ "meta": {...}, "data": [...] }`                      | **400 (Parámetros inválidos)**, **401 (No autorizado)**                                                                               |
    | **Ver profesor**        | GET    | `/api/v1/profesores/2`               | —                                                                                                                              | **200 (OK)**         | `{ "id_profesor": 2, "nombre": "Laura" }`               | **404 (No encontrado)**, **401 (No autorizado)**                                                                               |
    | **Modificar profesor**  | PUT    | `/api/v1/profesores/2`               | `{"especialidad": "Dibujo", "email": "laura@nueva.com", "telefono": "600123000"}` | **200 (OK)**         | `{ "id_profesor": 2, "email": "laura@nueva.com" }`      | **400**, **404**, **401**                                                                     |
