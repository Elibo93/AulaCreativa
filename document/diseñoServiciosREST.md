...
- **Alumnos**
    ...
    | **Modificar alumno**  | PUT  | `/api/v1/alumnos/42`              | `{ "telefono": "600000000" }`                                                                                      | **200 (OK)**         | `{ "id": 42, "telefono": "600000000" }`               | **400 (Solicitud incorrecta)**, **404 (No encontrado)**, **401 (No autorizado)**               |
...
- **Talleres**
    ...
    | **Modificar taller**  | PUT  | `/api/v1/talleres/10`            | `{ "capacidad": 14 }`                                                             | **200 (OK)**         | `{ "id": 10, "capacidad": 14 }`      | **400 (Solicitud incorrecta — capacidad inválida)**, **404 (No encontrado)**, **401 (No autorizado)** |
...
- **Inscripciones**
    ...
    | **Modificar estado**     | PUT  | `/api/v1/inscripciones/77`           | `{ "estado": "anulada" }`              | **200 (OK)**         | `{ "id": 77, "estado": "anulada" }` | **400 (Estado no válido)**, **404 (No encontrado)**, **401 (No autorizado)**                                                                     |
...
- **Asistencias**
    ...
    | **Modificar asistencia** | PUT | `/api/v1/asistencias/201`          | `{ "estado": "justificada" }`                                           | **200 (OK)**      | `{ "id": 201, "estado": "justificada" }` | **400 (Solicitud incorrecta)**, **404 (No encontrado)**, **401 (No autorizado)**                                                         |
...
- **Pagos**
    ...
    | **Actualizar estado** | PUT | `/api/v1/pagos/301`          | `{ "estado": "confirmado" }`                                 | **200 (OK)**      | `{ "id": 301, "estado": "confirmado" }` | **400 (Estado no válido)**, **404 (No encontrado)**, **401 (No autorizado)**                                                       |
